...
export const mockTerms = {
  ...
  4: { id: 4, type: 'FINANCE', title: '맞춤 추천을 위한 금융정보 활용', version: '1.0', content: '1. 활용 항목: 월 소득, 보유 자산, 대출·상환 정보(입력 시)\n2. 활용 목적: 정책·KB 금융상품 매칭, 매물 시세 적정성 판정 등 맞춤 추천 정확도 향상\n3. 미동의 시: 일부 맞춤 추천(정책·금융상품 매칭)이 제한될 수 있습니다.' },
}
