    ...
    <div class="splash">
        <div class="top-group">
            ...
            <div class="headline-group">
                ...
                <p class="headline-sub">2030 지방 정착 부동산 도우미</p>
            </div>
        </div>
        ...
        <div class="bottom-group">
            <button class="start-btn" type="button" @click="router.push('/login')">시작하기</button>
            <button class="seller-link" type="button" @click="router.push('/seller/properties/new')">집주인이신가요? 내 매물 등록하기</button>
        </div>
    </div>
</template>
...
.logo-img {
    ...
    object-fit: cover;
    border-radius: 30px;
    box-shadow: 0 10px 24px 0 rgba(89, 66, 0, 0.22);
}
