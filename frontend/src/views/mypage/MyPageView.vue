        ...
        <div class="scroll-area">
            <section class="profile-card">
                <span class="avatar">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                        <circle cx="11" cy="7.5" r="3.5" stroke="#60584c" stroke-width="1.6" />
                        <path d="M4 18c0-3.3 3.1-6 7-6s7 2.7 7 6" stroke="#60584c" stroke-width="1.6" stroke-linecap="round" />
                    </svg>
                </span>
            ...
            <section class="priority-card">
                ...
                <div class="priority-chips">
                    <span class="priority-chip" v-for="priority in sortedPriorities" :key="priority.priorityOrder">
                        {{ priority.priorityOrder }} {{ criterionLabel(priority.criterion) }}
                    </span>
                </div>
            </section>
            ...
            <nav class="menu-list">
                ...
                <button class="menu-row" type="button" @click="router.push('/reports')">
...
const sortedPriorities = computed(() => {
    return [...dashboard.value.priorities].sort((a, b) => a.priorityOrder - b.priorityOrder);
});
